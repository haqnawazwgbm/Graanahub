									...
									<li class="media notification-message">
										<a href="<?= base_url(); ?>Requests/list_requests">
											...
											<div class="media-body">
												<p class="m-0 noti-details"><span class="noti-title"><?= ucfirst($request['user_name']); ?></span> <span class="noti-title"><?= ucfirst($request['request_name']); ?></span> request has been accepted</p>
