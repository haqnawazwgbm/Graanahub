											...
											<div class="col-md-6 m-b-20">
												<div class="invoice-details">
													...
													<ul class="list-unstyled">
														<li>Salary Month: <span><?= date('F, Y', strtotime($date)); ?></span></li>
													</ul>
												</div>
											</div>
										</div>
												...
												<div>
													...
													<table class="table table-bordered">
														<tbody>
															...
															<tr>
																<td><strong>Total Deductions</strong> <span class="pull-right"><strong><?php $total_deductions = $user['tax_deduction'] + $user['provident_fund'] + $leave_deduction; echo number_format($total_deductions); ?></strong></span></td>
															</tr>
														</tbody>
													</table>
												</div>
