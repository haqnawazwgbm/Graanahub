        	...
        	$(document).ready(function() {
				...
				if($('.datatable').length > 0 ){
					...
					<?php if ($current_month_payroll) : ?>
							...
							$("#DataTables_Table_0_filter").find('label').append('<a href="#" id="generate_payroll" class="btn btn-primary"><i class="fa fa-plus"></i> Generate Payroll</a>');
						<?php else : ?>
							
							$("#DataTables_Table_0_filter").find('label').append('<a href="#" disabled class="btn btn-primary "><i class="fa fa-plus"></i> Generate Payroll</a>');
						<?php endif; ?>
